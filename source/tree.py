...
def load_command_tree(bot: Spunya, guild_id: int) -> None:
    ...
    async def stats(interaction: discord.Interaction, user: (discord.Member | None) = None) -> None:
    ...
    async def roll(interaction: discord.Interaction, low: int = 1, high: int = 100) -> None:
    ...
    @tree.command(name = "rate", description = "Оценка артефакта", guild = guild)
